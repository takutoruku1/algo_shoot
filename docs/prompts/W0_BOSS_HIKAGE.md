...
- **浄化の3幕（このキャラの肝）**：
  ...
  3. **改心後＝最高の笑顔**。algoと**友達**になり、生まれて初めての本物の自然な笑顔。「…わたしも、わらえた」。改心後は味方フォロワーとして残る（非致死）。
...
6. 配置・実装：
   ...
   - **3段階演出**：`Redeem()` で本体スプライトを (A)→(B1)大泣き に差し替え、約1.2秒後に (B2)最高の笑顔 へ。大泣き中に立ち絵付きの専用かけあい（ヒカゲ「…わたし、ずっと わらうの へただった」→ algo「そのままで いいよ。ともだちに なろう」→ ヒカゲ「…うん！」）。
