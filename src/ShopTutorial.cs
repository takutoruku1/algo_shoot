...
public partial class ShopTutorial : Node2D
{
    ...
    private static readonly (int who, string text, string face)[] ShopTutorialLines =
    {
        ...
        (1, "せっかく稼いだのです。使い道を、ご案内します。", "res://char/mina_face.png"),
        (1, "浄化すると、こぼれた心が散ります。あれを拾うと貯まる——“浄化した心”、♥の数が、それです。", "res://char/mina_face.png"),
        ...
        (1, "近づけば、向こうから寄ってきます。取り逃しても、面が終わればぜんぶ拾い上げますから。", "res://char/mina_face.png"),
        (1, "その心を、強化ショップで わたくしに注いでください。道は、一本きりです。", "res://char/mina_face.png"),
        (1, "上から順に。買えるのは、いつも いちばん上の ひとつだけ。——迷いようが、ありませんでしょう?", "res://char/mina_face.png"),
        (1, "先の段も、名前と値段はぜんぶ見えています。どこまで行けるかを、隠したりはしません。", "res://char/mina_face.png"),
        (1, "歯が立たない相手なら、無理は禁物。一度ここで強くなって、出直せばいいのです。", "res://char/mina_worried.png"),
        (1, "わたくしを、よく研いでおいてくださいね。——では、まいりましょう。", "res://char/mina_face.png"),
    };
