...
public partial class ScrollFx : Node2D
{
    ...
    public partial class Layer : Node2D
    {
        ...
        // ---- STAGE3 レイ：左へ通り過ぎる順位の光点（遠）／左へ流れる横ストリーク罫線（近）。Cold=青系。----
        ...
        // ---- STAGE1 あかり：左へ強く流れる斜めの雨筋（近）／奥のかすかな降りこめ・埃（遠）。----
        ...
        // 色は退勤後のフロアの寒色〜ニュートラル(0.78〜0.82, 0.84〜0.88, 1.0)。彩度は上げない。中明度背景なのでレイに近いαで読める。
        ...
        // ---- STAGE2 こはる：左へたなびく湯気/冷気の横ストランド（近）／宙を漂う小さな埃（遠）。----
