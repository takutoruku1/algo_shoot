...
public partial class DiffSelect : Node2D
{
    ...
    public override void _Process(double delta)
    {
        ...
        // もどる＝X／Esc／パッドB／右クリック（Esc は 2026-09-26 に「一つ前の画面へ」として復帰。メニューは M）。
    ...
    private void Dive()
    {
        ...
        // 他ジョブ潜行の章カウンタ：ダイブ確定のここで1回だけ数える（Stage 側の _Ready で数えると
        //   R リトライの ReloadCurrentScene でも増えて章が飛ぶ）。対象は本編3面×結び手以外のみ
