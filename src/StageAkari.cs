...
public partial class StageAkari : Node
{
    ...
    private static readonly (int who, string text, string face)[] Intro =
    {
        ...
        // 感動テコ入れ（docs/20260922/感動テコ入れ_改稿記録_2026-09-22.md ビート6）
        //   潜る前の儀式「いってまいります」を三面で反復する（こはる面・レイ面の Intro 末尾も同じ語）。
        //   FINAL（StageMina）では言えない＝不在で効き、E6 END「いってらっしゃいませ、ご主人様。」で送る側が反転する。
        (1, "では、ご主人様。——いってまいります。", MSmile),
    };
