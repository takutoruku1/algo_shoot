...
// Shop : ミナ強化ショップ。★2026-09-13 に「分岐なし・一本道13段」へ作り直した。
//
...
public partial class Shop : Node2D
{
    ...
    // 13段ぶんの高さ（通常34×11＋大44×2＋隙間6×12）= 534 に収める。RowTop=104 で下端は 638＝
    ...
    private const float RowH = 34f;            // 通常の段の高さ
    private const float RowBigH = 44f;         // 能力を覚える段（#6 #10）の高さ＝一回り大きい
    private const float RowGap = 6f;           // 段と段の隙間（ここに縦の連結線が通る）
