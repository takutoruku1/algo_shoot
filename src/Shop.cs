...
public partial class Shop : Node2D
{
    ...
    // ショップ退出先：復帰先(PendingResumeScene)が立っていれば、ハブでなくそのステージへ戻り
    // “中ボスの続き”から再開する（消費して以降は通常どおりハブへ）。それ以外は従来どおりハブ。
    //   2026-09-07 現在、これを立てる側は無い（初回ショップ説明が中ボス撃破→最初の面のボス撃破後へ移り、
    //   ボス撃破後はステージへ戻る必要が無くなったため）。仕組みは将来の途中離脱導線のために残してある。
