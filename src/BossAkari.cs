...
public partial class BossAkari : Enemy
{
    ...
    private static readonly (int who, string text, string face)[] Lines =
    {
        ...
        (1, "わたくしの声で? ご主人様が、直接おっしゃればいいでしょう。", ""),
        (0, "————ぼくの声じゃ、だめなんだ。……頼む。", SGentle),
        (1, "誰かを想うことは、罪じゃありません。どこの世界の法にも、そんな罪は無いんです。", ""),
        (1, "あなたが想ったから、その人は守った。庇ったのは——その人が、自分で選んだこと。", ""),
        (1, "あなたのせいにされたら、その人が選んだ意味まで、消えてしまう。", ""),
        (2, "でも……あたし、言えなかった……! 想いも、ごめんも、なにも……!", ""),
        (1, "言えなかった言葉は、消えません。届かなかった想いも、なかったことには、なりません。", ""),
        (1, "————きっと、とっくに、届いています。", ""),
        (2, "……すき、だったの。ずっと。それだけ、なのに。", ""),
        (1, "うん。————知ってるよ。", ""),
        (2, "……あったかい声が、した気がする。なんでかな、あの人の声に、似てた。", ""),
    };
