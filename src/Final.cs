...
public partial class Final : Node2D
{
    ...
    public override void _Ready()
    {
        ...
        T("ミナ", "穢れを祓うたび、それはわたくしの中に溜まっていた。");
        T("ミナ", "三人ぶんの、悲しみと、怒りと、届かなかった想い。");
        ...
        T("ミナ", "ただ、その声が、命綱でした。わたくしは、その光に向かって泳ぎました。");
        T("ミナ", "その光が、いつもよりずっと薄かったこと。わたくしは、気づいていました。");
        T("ミナ", "……ご主人様は、アホですね。");
        T("ミナ", "——それが、ご主人様と交わした、最後の軽口になりました。");
    }
