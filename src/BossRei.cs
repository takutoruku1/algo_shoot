...
public partial class BossRei : Enemy
{
    ...
    // 戦闘中に挟むレイの独白（HPがこの割合を下回るたび）。攻撃パターンも変える。
    ...
    // 改心のかけあい（who: 0=少年 / 1=ミナ / 2=レイ）
    private static readonly (int who, string text, string face)[] Lines =
    {
        (0, "ミナ。この子に、ぼくの言葉を届けてくれ。", SGentle),
        (1, "聞いてください。————あなたは、二番なんかじゃありません。", ""),
        (1, "あの天才が、本気で戦う価値があると思った相手は、後にも先にも、あなただけ。", ""),
        (1, "戦ってもらえなくなったのは、あなたに価値がないからじゃない。あいつの、勝手な事情です。", ""),
        (2, "……うそ。だって、あいつは……次を、くれなかった……!", ""),
        (1, "次は、あなたが勝つ。————それは、ずっと変わらない約束のはずだと。", ""),
        (2, "……次は、私が、勝つ……?", ""),
        (1, "ええ。————待ってる、そうですよ。", ""),
